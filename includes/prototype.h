...
void		handle_dolar_case(t_tokens *tk, t_list *env_lst, t_tokens *nxt_tkn);
...
char		*get_and_reconstruct_token(char *split_wrd, char *var_value, int i);
...
void		add_redir_to_cmd(t_cmd *cmd, t_tokens *redir_tk, t_tokens *file_tk);
